...
greet("Alice"); // -> Welcome Alice, good to see you again!
greet("Bob"); // Welcome 4, good to see you again!
greet("Mary"); //Welcome false, good to see you again!

// --^-- write your code here --^--

function logSeparator(numberOfExercises) {
